...
public:
    ...
    void adicionarSolido(SolidosR3 *solido) {
        solidosVector.push_back(solido);
    }
...
int main() {
    ...
    cout << "Area Total: " << conjunto.calcularAreaTotal() << endl;
    cout << "Volume Total: " << conjunto.calcularVolumeTotal() << endl;
    cout << endl;
    ...
    pontR3 = &esfera;
    cout << "Area Esfera: " << esfera.calculoArea() << endl;
